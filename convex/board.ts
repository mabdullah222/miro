...
export const remove=mutation({
    ...
    handler:async (ctx,args)=>{
        ...
        const existingFavorite=await ctx.db.query("userFavorites").withIndex("by_user_board",(q)=>q.eq("userId",identity.subject).eq("boardId",args.id)).unique()
        if (existingFavorite){
...
export const favorite=mutation({
    ...
    handler:async (ctx, args) =>{
        ...
        await ctx.db.insert("userFavorites",{
            userId,boardId:board._id,orgId:args.orgId
        })
        return;
    },
})
